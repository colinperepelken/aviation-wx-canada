    ...
    return <React.Fragment>
      ...
      <PageContent>
        <div id="weather-body">
          ...
          <CardGroup>
            <Card>
              <Card.Img variant="top" src="images/weather/flight_conditions.png" />
              <Card.Body className="text-center">
                <Card.Title>Flight Conditions</Card.Title>
              </Card.Body>
            </Card>
            <Card>
              <Card.Img variant="top" src="images/weather/sig_mid_wx.png" />
              <Card.Body className="text-center">
                <Card.Title>Significant Mid-level Weather</Card.Title>
              </Card.Body>
            </Card>
            <Card>
              <Card.Img variant="top" src="images/weather/upper_air_analysis.png" />
              <Card.Body className="text-center">
